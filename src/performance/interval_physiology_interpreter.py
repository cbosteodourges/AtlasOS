...
def interpret_interval_physiology(report: dict[str, Any]) -> dict[str, Any]:
    ...
    complete_speeds = all(value is not None and value > 0 for value in speeds)
    if complete_speeds:
    ...
    if complete_hr and heart_rate_reliable:
    ...
    if complete_recovery_drops and heart_rate_reliable:
    ...
    available_groups = sum((complete_speeds, complete_hr and heart_rate_reliable,
                            complete_recovery_drops and heart_rate_reliable))
