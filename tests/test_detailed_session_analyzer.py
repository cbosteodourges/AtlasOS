...
class DetailedSessionAnalyzerTests(unittest.TestCase):
    ...
    def test_cycling_prolonged_start_sensor_lock_uses_later_peak(self) -> None:
        heart_rates = (
            [171] * 180
            + [125] * (3300 - 180 - 120)
            + [154] * 120
        ...
        activity = LongitudinalActivity(
            atlas_id="garmin:cycling-prolonged-start-spike",
            start_time=self.start,
            activity_type="road",
            distance_km=24.25,
            duration_minutes=55.2,
        ...
        profile = AthleteProfile(
            athlete_id="cycling-prolonged-spike-profile",
            declared_level="intermediate",
            observed_level="intermediate",
            physiological=PhysiologicalReferences(
        ...
        self.assertTrue(result.data_integrity.heart_rate_spike_filtered)
        self.assertEqual(
            result.data_integrity.raw_maximum_heart_rate_bpm,
            171,
        )
        self.assertEqual(
