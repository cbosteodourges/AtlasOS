...
class PwaAssetsTests(unittest.TestCase):
    ...
    def test_styles_and_scripts_are_network_first(self):
        ...
        self.assertIn('CACHE_NAME = "atlas-shell-v72"', worker)
    ...
    def test_training_page_has_one_calendar_renderer(self):
        ...
        self.assertIn('atlas-training-calendar.js?v=124', page)
    ...
    def test_execution_report_has_a_grabbable_scrollbar_without_redundant_recovery_story(self):
        ...
        self.assertIn('performance-running.css?v=102', page)
        ...
        self.assertIn("function showSessionDialog(dialog)", calendar)
        self.assertIn('window.addEventListener("popstate"', calendar)
        self.assertIn("const decisionsPromise = syncWorkoutDecisions()", calendar)
        self.assertNotIn(
    ...
    def test_legacy_execution_timeline_is_rebased_on_planned_warmup(self):
        ...
        self.assertIn('Déroulé complet · prévu et réalisé', calendar)
        ...
        self.assertIn("hasCompleteWorkSpeed", calendar)
        self.assertIn("hasCompleteWorkHeartRate", calendar)
        self.assertIn("hasMeasuredRecoveries", calendar)
        self.assertIn(
            "Atlas ne conclut pas sur l’efficacité des récupérations",
            calendar,
        )
        self.assertIn("Compte rendu suspendu par Atlas", calendar)
    ...
    def test_desktop_content_tracks_the_rendered_header_height(self):
        ...
        self.assertIn("#atlasSessionDialog .workout-timeline-bars", styles)
        self.assertIn("min-width: 3px", styles)
