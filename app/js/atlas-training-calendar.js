...
${RESEARCH_TYPES.has(workout.workout_type) ? `
  ...
  function freeActivityTimelineSegments(report) {
    ...
    const zoneByType = {
      warm_up: 1, cool_down: 1, recovery: 1, z1: 1,
      z2: 2, z3: 3, tempo: 3, z4: 4, sv2: 4, z5: 5,
    ...
    const labelByType = {
      ...
      z4: "Effort soutenu · Z4",
      z5: "Effort intense · Z5",
    ...
    if (activity.sport === "cycling") {
      Object.assign(labelByType, {
        warm_up: "Vélo facile · Z1",
        cool_down: "Vélo facile · Z1",
        recovery: "Récupération vélo · Z1",
        z1: "Vélo facile · Z1",
        z2: "Endurance vélo · Z2",
        z3: "Effort vélo · Z3",
        z4: "Effort soutenu · Z4",
        z5: "Effort intense · Z5"
      });
    ...
    const segments = blocks
      .map(block => ({
        ...
        duration: Math.max(Number(block.duration_seconds) || 0, 0) / 60,
    ...
    return [{
      ...
      duration: Math.max(Number(activity.duration_minutes) || 0, 1 / 60),
  ...
  function cyclingExecutionReportHtml(report, workout) {
    ...
    return `
      <section class="execution-report execution-report-narrative">
        ...
        ${timelineHtml(freeActivityTimelineSegments(report), "Intensité vélo réalisée")}
                ...
                <section class="narrative-analysis-section interval-analysis-section">
                  ...
                  <div class="drift-reading-line">
                    ...
                    <div>
                      ...
                      <strong>${reportPace(3600 / Number(fastestWorkBlock?.average_speed_kmh))}</strong>
